...
import { formatUpcomingReleaseLabel, isUpcomingRelease } from "@/lib/utils"
                    ...
                    {isUpcoming ? (
                      <>
                        <CalendarDays
                          ...
                          className="-mt-[1px]"
                        />
                        {formatUpcomingReleaseLabel(game.igdbFirstReleaseDate!)}
                      </>
                    ) : (
                      <>
                        <Clock
                ...
                <div className="mt-auto flex flex-col gap-1 pt-3 empty:pt-0">
                  {steamPrice && (
                    <div className="flex items-center">
                      ...
                      <PriceLayout
                        onSale={
                          steamPrice.currentPrice !== steamPrice.regularPrice &&
