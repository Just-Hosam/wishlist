        ...
        <div className="relative flex-1">
          ...
          {query && (
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full p-1 text-gray-400 transition-all duration-200 animate-in fade-in zoom-in-50 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-gray-700 dark:hover:text-gray-300"
